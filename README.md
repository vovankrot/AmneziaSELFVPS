...
- 🔀 **Сервер и протокол переключаются прямо с главного экрана.** Один тап по серверу или протоколу — список открывается снизу, VPN сам переподключается на новый вариант, вручную отключаться не нужно.
...
<div align="center">
<img src="docs/screenshots/server_picker.png" width="300" alt="Выбор сервера"/>
<img src="docs/screenshots/protocol_picker.png" width="300" alt="Выбор протокола"/>
</div>
...
| 🧰 Build Studio (собрать самому) | `SelfvpsBuildStudio.exe` |
...
> ⚠️ **Обязательно положи `SelfvpsBuildStudio.exe` в ту папку, куда распаковал код с GitHub** — она ищет исходники рядом с собой.
