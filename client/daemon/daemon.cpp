...
// For Windows min MTU value is 1280 (the smallest MTU legal with IPv6).
  ...
  config.m_deviceIpv4Address = obj.value("deviceIpv4Address").toString().trimmed();
  config.m_deviceIpv6Address = obj.value("deviceIpv6Address").toString().trimmed();
  ...
  config.m_serverIpv4AddrIn = obj.value("serverIpv4AddrIn").toString().trimmed();
  config.m_serverIpv6AddrIn = obj.value("serverIpv6AddrIn").toString().trimmed();
