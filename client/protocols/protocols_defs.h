...
namespace amnezia
{
    namespace config_key
    {
        ...
        constexpr char bypassRuSitesGeo[] = "bypassRuSitesGeo";
        constexpr char xrayRouterConfig[] = "xray_router_config";
    ...
    namespace protocols
    {
        ...
        namespace xray
        {
            ...
            constexpr char accessLogPath[] = "/opt/amnezia/xray/access.log";
            ...
            constexpr char xhttpPathPath[] = "/opt/amnezia/xray/xray_xhttp_path.key";
        ...
        namespace ssxray
        {
            constexpr char serverConfigPath[] = "/opt/amnezia/ssxray/server.json";
            constexpr char passwordPath[] = "/opt/amnezia/ssxray/ss_password.key";
            constexpr char defaultCipher[] = "2022-blake3-aes-256-gcm";

            constexpr char defaultPort[] = "15327";
            constexpr char defaultLocalProxyPort[] = "10800";
        }

        namespace hysteria2
        {
            // Server-side paths inside the Docker container.
            constexpr char configPath[] = "/opt/amnezia/hysteria2/config.yaml";
            constexpr char passwordPath[] = "/opt/amnezia/hysteria2/hysteria2_password.key";
            constexpr char certPath[] = "/opt/amnezia/hysteria2/hysteria2_server.crt";
            constexpr char masqueradeHostPath[] = "/opt/amnezia/hysteria2/hysteria2_masquerade_host.key";
            constexpr char obfsPasswordPath[] = "/opt/amnezia/hysteria2/hysteria2_obfs_password.key";

            // Hysteria 2 is UDP. With salamander obfs the packets are random noise
            // (not recognizable QUIC), so we deliberately AVOID udp/443 — RKN/TSPU
            // throttles the QUIC port hardest. A high non-443 port + obfs passes
            // (verified: plain UDP to :443 and :40000 dropped, obfs on :44444 passed).
            constexpr char defaultPort[] = "44443";
            constexpr char defaultLocalProxyPort[] = "10809";
            constexpr char defaultLocalAddr[] = "10.34.0.2";
            constexpr char defaultMasqueradeHost[] = "www.bing.com";
        }

        namespace anytls
        {
            constexpr char passwordPath[] = "/opt/amnezia/anytls/anytls_password.key";

            constexpr char defaultPort[] = "8443";
            constexpr char defaultLocalProxyPort[] = "10810";
            constexpr char defaultLocalAddr[] = "10.35.0.2";
            constexpr char defaultSni[] = "www.microsoft.com";
        }
