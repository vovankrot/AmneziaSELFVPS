...
amnezia::ServiceType ProtocolProps::protocolService(Proto p)
{
    ...
    case Proto::SSXray: return ServiceType::Vpn;
    case Proto::Hysteria2: return ServiceType::Vpn;
    case Proto::AnyTls: return ServiceType::Vpn;
...
int ProtocolProps::defaultPort(Proto p)
{
    ...
    case Proto::SSXray: return QString(protocols::shadowsocks::defaultPort).toInt();
    case Proto::Hysteria2: return QString(protocols::hysteria2::defaultPort).toInt();
    case Proto::AnyTls: return QString(protocols::anytls::defaultPort).toInt();
...
bool ProtocolProps::defaultPortChangeable(Proto p)
{
    ...
    case Proto::SSXray: return true;
    case Proto::Hysteria2: return true;
    case Proto::AnyTls: return true;
...
TransportProto ProtocolProps::defaultTransportProto(Proto p)
{
    ...
    case Proto::Hysteria2: return TransportProto::Udp;
    case Proto::AnyTls: return TransportProto::Tcp;
...
bool ProtocolProps::defaultTransportProtoChangeable(Proto p)
{
    ...
    case Proto::SSXray: return false;
    case Proto::Hysteria2: return false;
    case Proto::AnyTls: return false;
