...
namespace amnezia
{
    ...
    public:
        ...
        Q_INVOKABLE static bool supportsSiteSplitTunneling(amnezia::DockerContainer container);
        ...
        Q_INVOKABLE static bool supportsUserManagement(amnezia::DockerContainer container);
