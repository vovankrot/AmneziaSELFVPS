...
public:
    ...
    void systemProxyDetectedNotification(const QString& proxyServer);
    void systemProxyAutoDisabledNotification(const QString& proxyServer);
