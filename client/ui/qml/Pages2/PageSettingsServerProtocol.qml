        ...
        delegate: ColumnLayout {
            ...
            LabelWithButtonType {
                ...
                clickedFunction: function() {
                    ...
                    case ProtocolEnum.Hysteria2: Hysteria2ConfigModel.updateModel(ProtocolsModel.getConfig()); break;
                    case ProtocolEnum.AnyTls: AnyTlsConfigModel.updateModel(ProtocolsModel.getConfig()); break;
