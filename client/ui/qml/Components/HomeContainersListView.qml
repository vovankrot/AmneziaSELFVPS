    ...
    delegate: Item {
        ...
        ColumnLayout {
            ...
            VerticalRadioButton {
                ...
                checkable: isInstalled && !ConnectionController.isConnectionInProgress
                ...
                onClicked: {
                    if (checked) {
                        ...
                        ConnectionController.switchToContainer(proxyDefaultServerContainersModel.mapToSource(index))
                    } else {
