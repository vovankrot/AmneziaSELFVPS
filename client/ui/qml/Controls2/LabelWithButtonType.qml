...
Item {
    ...
    property string badgeColor: AmneziaStyle.color.vibrantGreen
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            TintedIconType {
                anchors.centerIn: parent
                source: leftImageSource
                tintColor: leftImageColor
                iconWidth: leftImage.width > 0 ? leftImage.width : 24
                iconHeight: leftImage.height > 0 ? leftImage.height : 24
                visible: leftImageColor !== ""
            }
        }
