...
public slots:
    ...
    void openFileDialogAsync(const QString &acceptLabel, const QString &nameFilter, const QString &selectedFile = "",
                             const bool isSaveMode = false, const QString &defaultSuffix = "");
    void openDirectoryDialogAsync(const QString &acceptLabel, const QString &selectedDirectory = "");
...
signals:
    ...
    void fileDialogFinished(const QString &fileName);
