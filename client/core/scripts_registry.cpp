...
QString amnezia::scriptName(SharedScriptType type)
{
    ...
    case SharedScriptType::cleanup_host: return QLatin1String("cleanup_host.sh");
    case SharedScriptType::write_server_version: return QLatin1String("write_server_version.sh");
    case SharedScriptType::read_server_version: return QLatin1String("read_server_version.sh");
    case SharedScriptType::hot_reconfigure_xray: return QLatin1String("hot_reconfigure_xray.sh");
    default: return QString();
    }
}
...
QString amnezia::scriptName(ProtocolScriptType type)
{
    ...
    case ProtocolScriptType::hysteria2_template: return QLatin1String("template.yaml");
    case ProtocolScriptType::anytls_template: return QLatin1String("template.json");
    default: return QString();
    }
}
