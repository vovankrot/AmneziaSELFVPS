...
QString errorString(ErrorCode code) {
    ...
    case(ErrorCode::ServerCommandFailedError): errorMessage = QObject::tr("Server command failed"); break;
    ...
    case (ErrorCode::XrayExecutableCrashed): errorMessage = QObject::tr("XRay executable crashed or failed to start"); break;
