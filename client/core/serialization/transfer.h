...
struct VlessServerObject
{
    ...
    JSONSTRUCT_REGISTER(VlessServerObject, F(address, id, port, flow, encryption, network, security, serverName, publicKey, shortId, fingerprint, spiderX, xhttpPath, xhttpMode))
};
